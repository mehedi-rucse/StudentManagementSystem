...
?>
<h1 class="text-primary"><i class="fas fa-users"></i>  All Departments<small class="text-warning"> Department List!</small></h1>
      ...
      <?php 
        if (isset($_GET['delete'])) {
          if ($_GET['delete']=='success') {
            echo "<p style='color: green; font-weight: bold;'>Department Deleted Successfully!</p>";
          }  
        }
        if (isset($_GET['delete'])) {
          if ($_GET['delete']=='error') {
            echo "<p style='color: red'; font-weight: bold;>Department Not Deleted!</p>";
          }  
        }
        if (isset($_GET['edit'])) {
          if ($_GET['edit']=='success') {
            echo "<p style='color: green; font-weight: bold; '>Department Edited Successfully!</p>";
          }  
        }
        if (isset($_GET['edit'])) {
          if ($_GET['edit']=='error') {
            echo "<p style='color: red; font-weight: bold;'>Department Not Edited!</p>";
          }  
        }
      ?>
    </div>
  ...
  <tbody>
    <?php 
      ...
      <tr>
        <?php 
        echo '<td>'.$i.'</td>
          <td>'.ucwords($result['department_name']).'</td>
