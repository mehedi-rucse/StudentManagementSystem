...
?>
        <br>
        <h3 class="year-sem">Second Year <br>First Semester</h3>
        <?php 
             ...
             $result_query = "SELECT AVG(cgpa) as avg_cgpa FROM about_me,result,course_wise_result WHERE about_me.roll_id = '$_SESSION[roll]' AND
                            about_me.about_me_id =result.about_me_id and result.year='2nd' AND
...
<div>
        <?php 
            ...
            $query = "SELECT * FROM about_me,result,course_wise_result,course_information WHERE about_me.roll_id = '$_SESSION[roll]' AND
                                    ...
                                    course_wise_result.course_id = course_information.course_id and result.year='2nd' AND result.semester= '1st'";
                 ...
                 while($row = mysqli_fetch_assoc($query_run)){
                         ...
                         echo"<tr>";
                                ...
                                if($row['cgpa']!='0'){
                                    ...
                                    echo "<td>".$row['credits']-$row['credits']."</td>";
