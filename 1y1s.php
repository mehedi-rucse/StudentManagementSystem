        ...
        <br>
         <?php 
            ...
            $result_query = "SELECT AVG(cgpa) as avg_cgpa FROM about_me,result,course_wise_result WHERE about_me.roll_id = '$_SESSION[roll]' AND
                                                about_me.about_me_id =result.about_me_id and result.year='1st' AND
                ...
                ?>
                    ...
                    <label>CGPA:</label>
                    <input type="text" size="4" style="font-weight:bold;" value="<?php echo number_format($result_row['avg_cgpa'],3); ?>"disabled>
                    <?php 
...
<div>
        ...
        <?php 
            ...
            $query = "SELECT * FROM about_me,result,course_wise_result,course_information WHERE about_me.roll_id = '$_SESSION[roll]' AND
                                    ...
                                    course_wise_result.course_id = course_information.course_id and result.year='1st' AND result.semester= '1st'";
