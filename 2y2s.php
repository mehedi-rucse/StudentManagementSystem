...
?>
        <br>
        <h3 class="year-sem">Second Year <br>Second Semester</h3>
        <?php 
...
<div>
        ...
        <?php 
            ...
            $query = "SELECT * FROM about_me,result,course_wise_result,course_information WHERE about_me.roll_id = '$_SESSION[roll]' AND
                                    ...
                                    course_wise_result.course_id = course_information.course_id and result.year='2nd' AND result.semester= '2nd'";
